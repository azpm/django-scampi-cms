...
__all__ = ['LocalizedSectionManager', 'LocalizedElementManager', 'ThemeManager', 'BaseActiveLinkRefs',
           'RealmManager', 'SectionManager', 'CommuneManager', 'SliceManager', 'NamedBoxManager', 'ApplicationManager']
...
class NamedBoxManager(models.Manager):
    def get_by_natural_key(self, commune, slice_order, grid_y, grid_x, display_order, keyname):
        return self.get(slice__commune__keyname=commune, slice__display_order=slice_order, gridx=grid_x, gridy=grid_y,
                        display_order=display_order, pkeyname=keyname)
