...
class PickerMixin(ContextMixin, View):
    picker = None
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if 'picker' in kwargs:
            ...
            self.picker = get_object_or_404(DynamicPicker.objects.select_related('commune'), keyname=picker_key,
        ...
        return super(PickerMixin, self).dispatch(request, *args, **kwargs)

    def get_context_data(self, **kwargs):
        logger.debug("PickerMixin.get_context_data started")
        # get the existing context
        context = super(PickerMixin, self).get_context_data(**kwargs)
