...
class ArticleTranslationForm(forms.ModelForm):
    ...
    synopsis = forms.CharField(
        ...
        required=False,
        help_text=_(
            "Article Synopsis, markup(down) allowed: "
            "see <a href='http://daringfireball.net/projects/markdown/syntax'>Markdown Syntax</a> for help")
    )
    body = forms.CharField(
        widget=forms.Textarea(attrs={'cols': 80, 'rows': 30}),
        help_text=_(
            "Article body, markup(down) allowed: "
            "see <a href='http://daringfireball.net/projects/markdown/syntax'>Markdown Syntax</a> for help")
    )
