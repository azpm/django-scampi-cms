...
from libscampi.contrib.cms.newsengine.urls import published_archive_urls, story_urls, feeds, api as newsengine_api

urlpatterns = patterns('libscampi.contrib.cms.communism.views',
    url(r'^api/newsengine/', include(newsengine_api, 'api')),
