...
class PublishArchivePage(PublishMixin, PickerMixin, CMSPageNoView):
    ...
    def get_queryset(self):
        ...
        categories = StoryCategory.genera.for_cloud(qs).exclude(
            pk__in=list(self.base_categories.values_list('id', flat=True)))
    ...
    def get_context_data(self, **kwargs):
        ...
        context = super(PublishArchivePage, self).get_context_data(**kwargs)
    ...
    def base_template_path_arguments(self):
        return (
            "{0:>s}/newsengine/archive".format(self.commune.theme.keyname),
            self.realm.keyname,
            self.commune.keyname,
            self.picker.keyname,
        )
...
class PublishArchiveIndex(PublishArchivePage, ArchiveIndexView):
    ...
    def get_template_names(self):
        theme, realm, commune, picker = self.base_template_path_arguments
        return (
            "{0:>s}/{1:>s}/{2:>s}/{3:>s}/index.html".format(theme, realm, commune, picker),
            "{0:>s}/{1:>s}/{2:>s}/index.html".format(theme, realm, commune),
...
class PublishArchiveYear(PublishArchivePage, YearArchiveView):
    ...
    def get_template_names(self):
        theme, realm, commune, picker = self.base_template_path_arguments
        return (
            "{0:>s}/{1:>s}/{2:>s}/{3:>s}/year.html".format(theme, realm, commune, picker),
            "{0:>s}/{1:>s}/{2:>s}/year.html".format(theme, realm, commune),
            "{0:>s}/{1:>s}/year.html".format(theme, realm),
            "{0:>s}/year.html".format(theme),
        )
...
class PublishArchiveMonth(PublishArchivePage, MonthArchiveView):
    ...
    def get_page_title(self):
        return "{0:>s}, Archive {1:>s}/{2:>s} - {3:>s}".format(self.picker.name, self.get_month(), self.get_year(),
                                                               self.picker.commune.name)

    def get_template_names(self):
        theme, realm, commune, picker = self.base_template_path_arguments
        return (
            "{0:>s}/{1:>s}/{2:>s}/{3:>s}/month.html".format(theme, realm, commune, picker),
            "{0:>s}/{1:>s}/{2:>s}/month.html".format(theme, realm, commune),
            "{0:>s}/{1:>s}/month.html".format(theme, realm),
            "{0:>s}/month.html".format(theme),
        )
...
class PublishArchiveDay(PublishArchivePage, DayArchiveView):
    ...
    def get_page_title(self):
        return "{0:>s}, Archive {1:>s}/{2:>s}/{3:>s} - {4:>s}".format(self.picker.name, self.get_day(),
    ...
    def get_template_names(self):
        theme, realm, commune, picker = self.base_template_path_arguments
        return (
            "{0:>s}/{1:>s}/{2:>s}/{3:>s}/day.html".format(theme, realm, commune, picker),
            "{0:>s}/{1:>s}/{2:>s}/day.html".format(theme, realm, commune),
            "{0:>s}/{1:>s}/day.html".format(theme, realm),
            "{0:>s}/day.html".format(theme),
        )
...
class PublishArchiveDetail(PublishArchivePage, DateDetailView):
    ...
    def get_template_names(self):
        theme, realm, commune, picker = self.base_template_path_arguments
        return (
            "{0:>s}/{1:>s}/{2:>s}/{3:>s}/{4:>s}.html".format(theme, realm, commune, picker, self.object.slug),
            "{0:>s}/{1:>s}/{2:>s}/{3:>s}/detail.html".format(theme, realm, commune, picker),
            "{0:>s}/{1:>s}/{2:>s}/detail.html".format(theme, realm, commune),
