...
from libscampi.contrib.cms.renaissance import models
...
class RankedImageInline(RankedItemInline, admin.TabularInline):
    model = models.RankedImage
    raw_id_fields = ['image']


class RankedVideoInline(RankedItemInline, admin.TabularInline):
    model = models.RankedVideo


class RankedAudioInline(RankedItemInline, admin.TabularInline):
    model = models.RankedAudio


class RankedDocumentInline(RankedItemInline, admin.TabularInline):
    model = models.RankedDocument


class RankedObjectInline(RankedItemInline, admin.TabularInline):
    model = models.RankedObject
